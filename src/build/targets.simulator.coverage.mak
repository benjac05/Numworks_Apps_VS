...
output/test_coverage.$(EXE): LDFLAGS += --coverage
output/test_coverage.$(EXE): $(call flavored_object_for,$(coverage_src),consoledisplay)

coverage.info: output/test_coverage.$(EXE)
