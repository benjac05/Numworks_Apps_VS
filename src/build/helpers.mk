...
# extra rule that can build source files within the output. This is useful
...
$(addprefix output/,$(strip $(2))): $(strip $(3)) | $$$$(@D)/.
	@ echo "$(shell printf "%-8s" $(strip $(1)))$$(@:output/%=%)"
	$(Q) $(4)
endif
...
.PRECIOUS: output/$(1)/%.$$(EXE)
output/$(1)/%.$$(EXE): force_remake
	$(Q) echo "MAKE    ARCH=$(1)"
	$(Q) $$(MAKE) ARCH=$(1)  $$*.$$(EXE)
endef
